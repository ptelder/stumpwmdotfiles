...
(load "/home/pliny/.emacs.d/elpa/slime-20160704.1500/swank-loader.lisp")
(swank-loader:init)
(defcommand swank () ()
...
#+BEGIN_SRC lisp 
(let ((urxvt (sb-ext:run-program "/usr/bin/pidof" '("urxvtd"))))
     (if (= (sb-ext:process-exit-code urxvt) 1)
        (sb-ext:run-program "/usr/bin/urxvtd" '("-q" "-o" "-f"))
     )
